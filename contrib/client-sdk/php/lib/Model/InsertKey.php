...
class InsertKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets ttl
     *
     * @param int|null $ttl The time-to-live (TTL) for this key, in seconds
     *
     * @return self
     */
    public function setTtl($ttl)
    {
        ...
        if (!is_null($ttl) && ($ttl < 0)) {
            throw new \InvalidArgumentException('invalid value for $ttl when calling InsertKey., must be bigger than or equal to 0.');
        }
