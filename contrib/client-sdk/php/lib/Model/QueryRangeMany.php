...
/**
 * QueryRangeMany Class Doc Comment
 *
 * @category Class
 ...
 */
class QueryRangeMany implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QueryRangeMany';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['indices'] === null) {
    ...
    public function setCount($count)
    {
        ...
        if (!is_null($count) && ($count > 65535)) {
            throw new \InvalidArgumentException('invalid value for $count when calling QueryRangeMany., must be smaller than or equal to 65535.');
        }
        if (!is_null($count) && ($count < 1)) {
            throw new \InvalidArgumentException('invalid value for $count when calling QueryRangeMany., must be bigger than or equal to 1.');
        }
     ...
     * Sets indices
     *
     * @param string[] $indices List of indices to search
     *
     * @return self
     */
    ...
    public function setRange($range)
    {
        ...
        if (($range > 65535)) {
            throw new \InvalidArgumentException('invalid value for $range when calling QueryRangeMany., must be smaller than or equal to 65535.');
        }
        if (($range < 0)) {
            throw new \InvalidArgumentException('invalid value for $range when calling QueryRangeMany., must be bigger than or equal to 0.');
        }
