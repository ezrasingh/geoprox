...
/**
 * EncodeLatLng Class Doc Comment
 *
 * @category Class
 ...
 */
class EncodeLatLng implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EncodeLatLng';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['depth'] > 10)) {
            $invalidProperties[] = "invalid value for 'depth', must be smaller than or equal to 10.";
        }

        if (($this->container['depth'] < 1)) {
     ...
     * Sets depth
     *
     * @param int $depth Determines geohash length
     *
     * @return self
     */
    public function setDepth($depth)
    {
        ...
        if (($depth > 10)) {
            throw new \InvalidArgumentException('invalid value for $depth when calling EncodeLatLng., must be smaller than or equal to 10.');
        }
        if (($depth < 1)) {
            throw new \InvalidArgumentException('invalid value for $depth when calling EncodeLatLng., must be bigger than or equal to 1.');
        }
