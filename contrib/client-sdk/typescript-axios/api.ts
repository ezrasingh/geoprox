...
export const GeoshardApiApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} index Geospatial index name
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
         ...
         * @param {string} index Geospatial index name
         * @param {InsertKeyBatch} insertKeyBatch 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        insertKeyBatch: async (index: string, insertKeyBatch: InsertKeyBatch, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'index' is not null or undefined
            assertParamExists('insertKeyBatch', 'index', index)
            // verify required parameter 'insertKeyBatch' is not null or undefined
            assertParamExists('insertKeyBatch', 'insertKeyBatch', insertKeyBatch)
            const localVarPath = `/api/v1/shard/{index}/batch/`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(insertKeyBatch, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        queryRange: async (index: string, lat: number, lng: number, range: number, count?: number | null, sorted?: boolean | null, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'index' is not null or undefined
         ...
         * @param {Array<string>} indices List of indices to search
         * @param {number} lat Latitude
         * @param {number} lng Longitude
         * @param {number} range Search radius in kilometers
         * @param {number | null} [count] Maximum number of neighbors that can be returned (default 100)
         ...
         * @throws {RequiredError}
         */
        queryRangeMany: async (indices: Array<string>, lat: number, lng: number, range: number, count?: number | null, sorted?: boolean | null, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'indices' is not null or undefined
            assertParamExists('queryRangeMany', 'indices', indices)
            // verify required parameter 'lat' is not null or undefined
            assertParamExists('queryRangeMany', 'lat', lat)
            // verify required parameter 'lng' is not null or undefined
            assertParamExists('queryRangeMany', 'lng', lng)
            // verify required parameter 'range' is not null or undefined
            assertParamExists('queryRangeMany', 'range', range)
            const localVarPath = `/api/v1/shard/`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @param {string} index Geospatial index name
         * @param {RemoveKeyBatch} removeKeyBatch 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        removeKeyBatch: async (index: string, removeKeyBatch: RemoveKeyBatch, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'index' is not null or undefined
            assertParamExists('removeKeyBatch', 'index', index)
            // verify required parameter 'removeKeyBatch' is not null or undefined
            assertParamExists('removeKeyBatch', 'removeKeyBatch', removeKeyBatch)
            const localVarPath = `/api/v1/shard/{index}/batch/`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(removeKeyBatch, localVarRequestOptions, configuration)
...
export const GeoshardApiApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async insertKeyBatch(index: string, insertKeyBatch: InsertKeyBatch, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InsertKeyBatchResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.insertKeyBatch(index, insertKeyBatch, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['GeoshardApiApi.insertKeyBatch']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Search geospatial index for all keys within some distance
         ...
         * @throws {RequiredError}
         */
        async queryRange(index: string, lat: number, lng: number, range: number, count?: number | null, sorted?: boolean | null, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QueryRangeResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.queryRange(index, lat, lng, range, count, sorted, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async queryRangeMany(indices: Array<string>, lat: number, lng: number, range: number, count?: number | null, sorted?: boolean | null, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QueryRangeManyResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.queryRangeMany(indices, lat, lng, range, count, sorted, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['GeoshardApiApi.queryRangeMany']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Removes key from geospatial index
         ...
         * @throws {RequiredError}
         */
        async removeKey(index: string, removeKey: RemoveKey, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RemoveKeyResponse>> {
         ...
         * @throws {RequiredError}
         */
        async removeKeyBatch(index: string, removeKeyBatch: RemoveKeyBatch, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RemoveKeyBatchResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.removeKeyBatch(index, removeKeyBatch, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['GeoshardApiApi.removeKeyBatch']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const GeoshardApiApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        insertKeyBatch(index: string, insertKeyBatch: InsertKeyBatch, options?: any): AxiosPromise<InsertKeyBatchResponse> {
            return localVarFp.insertKeyBatch(index, insertKeyBatch, options).then((request) => request(axios, basePath));
        },
        /**
         * Search geospatial index for all keys within some distance
         * @summary Search index for objects nearby
         ...
         * @throws {RequiredError}
         */
        queryRange(index: string, lat: number, lng: number, range: number, count?: number | null, sorted?: boolean | null, options?: any): AxiosPromise<QueryRangeResponse> {
            return localVarFp.queryRange(index, lat, lng, range, count, sorted, options).then((request) => request(axios, basePath));
        },
        /**
         * Search geospatial many indices for all keys within some distance
         * @summary Search multiple indices for objects nearby
         ...
         * @throws {RequiredError}
         */
        queryRangeMany(indices: Array<string>, lat: number, lng: number, range: number, count?: number | null, sorted?: boolean | null, options?: any): AxiosPromise<QueryRangeManyResponse> {
            return localVarFp.queryRangeMany(indices, lat, lng, range, count, sorted, options).then((request) => request(axios, basePath));
        },
        /**
         * Removes key from geospatial index
         * @summary Remove key from index
         ...
         * @throws {RequiredError}
         */
        removeKey(index: string, removeKey: RemoveKey, options?: any): AxiosPromise<RemoveKeyResponse> {
         ...
         * @throws {RequiredError}
         */
        removeKeyBatch(index: string, removeKeyBatch: RemoveKeyBatch, options?: any): AxiosPromise<RemoveKeyBatchResponse> {
            return localVarFp.removeKeyBatch(index, removeKeyBatch, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class GeoshardApiApi extends BaseAPI {
     ...
     * @memberof GeoshardApiApi
     */
    public insertKeyBatch(index: string, insertKeyBatch: InsertKeyBatch, options?: RawAxiosRequestConfig) {
        return GeoshardApiApiFp(this.configuration).insertKeyBatch(index, insertKeyBatch, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof GeoshardApiApi
     */
    public queryRange(index: string, lat: number, lng: number, range: number, count?: number | null, sorted?: boolean | null, options?: RawAxiosRequestConfig) {
        return GeoshardApiApiFp(this.configuration).queryRange(index, lat, lng, range, count, sorted, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof GeoshardApiApi
     */
    public queryRangeMany(indices: Array<string>, lat: number, lng: number, range: number, count?: number | null, sorted?: boolean | null, options?: RawAxiosRequestConfig) {
        return GeoshardApiApiFp(this.configuration).queryRangeMany(indices, lat, lng, range, count, sorted, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof GeoshardApiApi
     */
    public removeKeyBatch(index: string, removeKeyBatch: RemoveKeyBatch, options?: RawAxiosRequestConfig) {
        return GeoshardApiApiFp(this.configuration).removeKeyBatch(index, removeKeyBatch, options).then((request) => request(this.axios, this.basePath));
    }
}
