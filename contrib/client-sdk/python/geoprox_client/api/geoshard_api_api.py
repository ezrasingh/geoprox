...
class GeoshardApiApi:
    ...
    def create_index(
        self,
        index: Annotated[StrictStr, Field(description="Geospatial index name")],
        ...
        :param index: Geospatial index name (required)
        :type index: str
    ...
    def insert_key_batch(
        ...
        :param index: Geospatial index name (required)
        :type index: str
        :param insert_key_batch:  (required)
        :type insert_key_batch: InsertKeyBatch
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._insert_key_batch_serialize(
            index=index,
            insert_key_batch=insert_key_batch,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def insert_key_batch_with_http_info(
        self,
        index: Annotated[StrictStr, Field(description="Geospatial index name")],
        insert_key_batch: InsertKeyBatch,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InsertKeyBatchResponse]:
        """Insert multiple keys into index
    ...
    @validate_call
    def insert_key_batch_without_preload_content(
        self,
        index: Annotated[StrictStr, Field(description="Geospatial index name")],
        insert_key_batch: InsertKeyBatch,
        _request_timeout: Union[
    ...
    def _insert_key_batch_serialize(
        self,
        index,
        insert_key_batch,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if insert_key_batch is not None:
            _body_params = insert_key_batch
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/v1/shard/{index}/batch/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def query_range_many(
        self,
        indices: Annotated[List[StrictStr], Field(description="List of indices to search")],
        lat: Annotated[Union[StrictFloat, StrictInt], Field(description="Latitude")],
        lng: Annotated[Union[StrictFloat, StrictInt], Field(description="Longitude")],
        range: Annotated[int, Field(strict=True, ge=0, description="Search radius in kilometers")],
        count: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Maximum number of neighbors that can be returned (default 100)")] = None,
        ...
        :param indices: List of indices to search (required)
        ...
        _param = self._query_range_many_serialize(
            indices=indices,
            lat=lat,
            lng=lng,
            range=range,
    ...
    @validate_call
    def query_range_many_with_http_info(
        self,
        indices: Annotated[List[StrictStr], Field(description="List of indices to search")],
        lat: Annotated[Union[StrictFloat, StrictInt], Field(description="Latitude")],
        lng: Annotated[Union[StrictFloat, StrictInt], Field(description="Longitude")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[QueryRangeManyResponse]:
        """Search multiple indices for objects nearby
    ...
    @validate_call
    def query_range_many_without_preload_content(
        self,
        indices: Annotated[List[StrictStr], Field(description="List of indices to search")],
        lat: Annotated[Union[StrictFloat, StrictInt], Field(description="Latitude")],
        lng: Annotated[Union[StrictFloat, StrictInt], Field(description="Longitude")],
    ...
    def _query_range_many_serialize(
        self,
        indices,
        lat,
        lng,
    ...
    def remove_key_batch(
        ...
        :param index: Geospatial index name (required)
        :type index: str
        :param remove_key_batch:  (required)
        :type remove_key_batch: RemoveKeyBatch
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._remove_key_batch_serialize(
            index=index,
            remove_key_batch=remove_key_batch,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def remove_key_batch_with_http_info(
        self,
        index: Annotated[StrictStr, Field(description="Geospatial index name")],
        remove_key_batch: RemoveKeyBatch,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RemoveKeyBatchResponse]:
        """Remove multiple keys from index
    ...
    @validate_call
    def remove_key_batch_without_preload_content(
        self,
        index: Annotated[StrictStr, Field(description="Geospatial index name")],
        remove_key_batch: RemoveKeyBatch,
        _request_timeout: Union[
    ...
    def _remove_key_batch_serialize(
        self,
        index,
        remove_key_batch,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if remove_key_batch is not None:
            _body_params = remove_key_batch
