...
class QueryRangeResponse(BaseModel):
    ...
    """ # noqa: E501
    found: List[KeysFoundInner] = Field(description="Resource keys found within range")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "found": [KeysFoundInner.from_dict(_item) for _item in obj["found"]] if obj.get("found") is not None else None
        })
        return _obj
