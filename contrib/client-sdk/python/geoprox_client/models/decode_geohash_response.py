...
class DecodeGeohashResponse(BaseModel):
    """
    ...
    lat_error: Union[StrictFloat, StrictInt] = Field(description="Latitude error")
    lng: Union[StrictFloat, StrictInt] = Field(description="Longitude")
    lng_error: Union[StrictFloat, StrictInt] = Field(description="Longitude error")
    __properties: ClassVar[List[str]] = ["lat", "lat_error", "lng", "lng_error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lat": obj.get("lat"),
            "lat_error": obj.get("lat_error"),
            "lng": obj.get("lng"),
            "lng_error": obj.get("lng_error")
        })
        return _obj
