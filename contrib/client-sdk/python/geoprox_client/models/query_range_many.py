...
class QueryRangeMany(BaseModel):
    """
    ...
    indices: List[StrictStr] = Field(description="List of indices to search")
    ...
    __properties: ClassVar[List[str]] = ["count", "indices", "lat", "lng", "range", "sorted"]
