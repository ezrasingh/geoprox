...
class QueryRangeManyResponse(BaseModel):
    """
    Returns indices and object keys found with their distance
    """ # noqa: E501
    errors: Dict[str, StrictStr] = Field(description="Contains information about any errors occured during batch search.")
    results: Dict[str, List[Neighbor]] = Field(description="Object keys found within range")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": dict(
                (_k,
                        [Neighbor.from_dict(_item) for _item in _v]
                        if _v is not None
                        else None
                )
