...
```shell
gem install ./geoprox_client-0.1.0.gem
```

(for development, run `gem install --dev ./geoprox_client-0.1.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'geoprox_client', '~> 0.1.0'
...
## Documentation for Models
 ...
 - [GeoproxClient::KeysFoundInner](docs/KeysFoundInner.md)
