...
pub async fn remove_key(configuration: &configuration::Configuration, index: &str, remove_key: models::RemoveKey) -> Result<models::InsertKeyResponse, Error<RemoveKeyError>> {
    let local_var_configuration = configuration;
