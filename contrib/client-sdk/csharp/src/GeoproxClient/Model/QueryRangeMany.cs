...
namespace GeoproxClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QueryRangeMany")]
    public partial class QueryRangeMany : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryRangeMany" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QueryRangeMany() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryRangeMany" /> class.
        /// </summary>
        /// <param name="count">Maximum number of neighbors that can be returned (default 100).</param>
        /// <param name="indices">List of indices to search (required).</param>
        ...
        public QueryRangeMany(int? count = default(int?), List<string> indices = default(List<string>), double lat = default(double), double lng = default(double), int range = default(int), bool? sorted = default(bool?))
        {
            // to ensure "indices" is required (not null)
            if (indices == null)
            {
                throw new ArgumentNullException("indices is a required property for QueryRangeMany and cannot be null");
            }
        ...
        /// </summary>
        /// <value>List of indices to search</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueryRangeMany {\n");
